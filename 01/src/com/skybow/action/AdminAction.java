...
import com.skybow.actionSuper.AdminSuperAction;
import com.skybow.dao.OpDB;
import com.skybow.model.CreatePage;

/**
 * 管理员相关操作Action
 * @author le 2015年6月18日 下午12:42:16
 * 
 */
public class AdminAction extends AdminSuperAction {
	...
	public String ListShow() {
		...
		if (!stateType.equals("all") && !payforType.equals("all")) { // 没有同时选择“付费状态”与“审核状态”中的“全部”选项
			...
			sqlsub = "SELECT  * FROM tb_info WHERE (info_type=?) AND (info_state=?) AND (info_payfor=?) ORDER BY info_date DESC limit "
					+ perR + "";
			params = new Object[3];
